...
export const KNOWN_PRODUCTS = [
    ...
    // ══════════════════════════════════════════════════════════════════════════
    {
        ...
        cylinder_sizes: [
            { external_mm: 30, internal_mm: 30, label: '30/30' },
            { external_mm: 30, internal_mm: 40, label: '30/40' },
            { external_mm: 30, internal_mm: 45, label: '30/45' },
            { external_mm: 30, internal_mm: 50, label: '30/50' },
            { external_mm: 35, internal_mm: 35, label: '35/35' },
            { external_mm: 35, internal_mm: 40, label: '35/40' },
            { external_mm: 35, internal_mm: 45, label: '35/45' },
            { external_mm: 40, internal_mm: 35, label: '40/35' },
            { external_mm: 40, internal_mm: 40, label: '40/40' },
            { external_mm: 40, internal_mm: 45, label: '40/45' },
            { external_mm: 45, internal_mm: 35, label: '45/35' },
            { external_mm: 45, internal_mm: 40, label: '45/40' },
            { external_mm: 45, internal_mm: 45, label: '45/45' },
            { external_mm: 45, internal_mm: 50, label: '45/50' },
            { external_mm: 50, internal_mm: 40, label: '50/40' },
            { external_mm: 50, internal_mm: 50, label: '50/50' },
